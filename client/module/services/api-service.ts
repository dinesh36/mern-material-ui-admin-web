...
// const basePath = 'https://sj2s6n1l99.execute-api.ap-south-1.amazonaws.com/api/'; // dev
// const basePath = 'https://3ymi19b6cl.execute-api.us-east-2.amazonaws.com/api/'; // prod
