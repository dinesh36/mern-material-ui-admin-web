...
const planNoteRoutes = require('../modules/plan-note/plan-note.routes');
import planPDFRoutes from '../modules/plan-pdf/plan-pdf.routes';
...
class ExpressServer {
  ...
  initModuleRoutes() {
    planRoutes.init(app, this.reqWrapper);
    planNoteRoutes.init(app, this.reqWrapper);
    planPDFRoutes.init(app);
